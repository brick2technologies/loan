...
function HeroSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Term Loan Form Data:", formData);
    openModal('term');
  };
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative z-10 max-w-xl lg:max-w-2xl mx-auto lg:mx-0 text-center lg:text-left">
              ...
              <p className="mt-6 text-base sm:text-lg md:text-xl text-[#374151] leading-relaxed max-w-prose mx-auto lg:mx-0">
                Secure long-term funding for business expansion, equipment purchase, office renovation, or large-scale projects.  
            ...
            <div className="hidden lg:block relative">
              <img
                src="/images/term-loan-hero.png"
                alt="Business expansion and growth with term loan support"
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
              ...
              >
                ...
                <option value="renovation">Office / Factory Renovation</option>
            ...
            <label className="flex items-start gap-3 text-sm text-gray-600 cursor-pointer select-none">
              ...
              <span className="leading-relaxed">
                I authorize sharing my information for term loan processing as per RBI guidelines & privacy policy.
              </span>
            </label>
          </form>
        </div>
    ...
    <section id="overview" className="py-16 px-6 bg-[#E5E7EB]">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="amplessoft text-4xl md:text-5xl font-bold text-gray-900 mb-5">What is a Term Loan?</h2>
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            A term loan is a long-term financing option that provides businesses with a lump sum amount for specific purposes like expansion, equipment purchase, office/factory renovation, or technology upgrade. It offers fixed or structured EMIs with longer repayment tenure.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-8">
            <div>
              ...
              <ul className="space-y-3 text-gray-600">
                ...
                <li className="flex items-start"><span className="text-[#0B0E14] mr-3 text-xl">•</span>Fixed or Structured EMI options</li>
              </ul>
            </div>
            <div>
              <h3 className="amplessoft text-2xl font-semibold text-gray-800 mb-4">Most Common Uses</h3>
              <p className="text-gray-600">
                Business expansion & new branch setup, purchase of machinery/equipment, office/factory renovation, technology & software upgrade, or any long-term capital investment for growth.
              </p>
            </div>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {[
              { title: "Business Expansion", desc: "Scale operations & open new locations" },
              { title: "Equipment Purchase", desc: "Buy machinery & tools" },
              { title: "Renovation", desc: "Upgrade office/factory infrastructure" },
              { title: "Technology Upgrade", desc: "Modern software & systems" },
              { title: "Capital Investment", desc: "Long-term growth projects" },
              { title: "Asset Creation", desc: "Build lasting business assets" },
            ].map((item) => (
              <div
                key={item.title}
...
// ────────────────────────────────────────────────────────────────────────────────
// TYPES OF TERM LOANS (unchanged)
// ────────────────────────────────────────────────────────────────────────────────
function TypesOfTermLoans() {
  const loanTypes = [
    {
      title: "Business Expansion Term Loan",
      description: "Fund new branch setup, market expansion, or capacity increase.",
      interest: "Starting 12%*",
      amount: "₹1 Lakh – ₹90 Lakhs",
      tenure: "12–60 months",
      bestFor: "Scaling operations",
      icon: "📈",
    },
    {
      title: "Equipment / Machinery Term Loan",
      description: "Finance purchase of new machinery, tools, or production equipment.",
      interest: "Starting 12%*",
      amount: "₹1 Lakh – ₹90 Lakhs",
      tenure: "12–60 months",
    ...
    {
      title: "Renovation / Infrastructure Term Loan",
      description: "Upgrade office, factory, showroom, or warehouse infrastructure.",
      interest: "Starting 12%*",
      amount: "₹1 Lakh – ₹90 Lakhs",
      tenure: "12–60 months",
      bestFor: "Infrastructure improvement",
      icon: "🏗️",
    },
    {
      title: "Technology Upgrade Term Loan",
      description: "Invest in modern software, IT systems, or digital transformation.",
      interest: "Starting 12%*",
      amount: "₹1 Lakh – ₹90 Lakhs",
      tenure: "12–60 months",
      bestFor: "Tech & digital businesses",
      icon: "💻",
    },
  ];
    ...
    <section id="types" className="bg-[#E5E7EB] py-16 md:py-20 px-5 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="amplessoft text-3xl sm:text-4xl md:text-5xl font-bold text-[#0B0E14]">Types of Term Loans</h2>
          <p className="mt-5 text-lg md:text-xl text-gray-700 max-w-3xl mx-auto">
            Choose the right term loan for your long-term business growth needs.
          </p>
        </div>
  ...
  const features = [
    {
      ...
      desc: "Get funding from <strong>₹1 Lakh – ₹90 Lakhs</strong> as per your need",
      highlight: "₹1L – ₹90L",
    },
    {
      icon: "📅",
    ...
    },
    {
      ...
      desc: "Fixed EMI or Structured EMI to match your cash flow",
    ...
    },
    {
      ...
      desc: "Fast processing & funds in your account quickly",
      highlight: "Fast Funding",
    },
    {
      icon: "🛡️",
      title: "No Collateral Required",
      desc: "Unsecured term loan — no asset pledging",
    ...
    <section id="features" className="bg-[#E5E7EB] py-16 md:py-20 px-5 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="amplessoft text-4xl md:text-5xl font-bold text-[#0B0E14]">Term Loan Features & Benefits</h2>
          <p className="mt-6 text-xl text-gray-700 max-w-3xl mx-auto">
            Long-term funding • Flexible repayment • Fast & easy • No collateral
          </p>
        </div>
...
function LoanDetails() {
  ...
  return (
    <section id="interest" className="bg-[#E5E7EB] py-16 md:py-20 px-5 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="amplessoft text-4xl md:text-5xl font-bold text-[#0B0E14]">Term Loan at a Glance</h2>
          <p className="mt-5 text-xl text-gray-700">Transparent • Affordable • Long-term</p>
        </div>
  ...
  return (
    <section id="eligibility" className="bg-[#E5E7EB] py-16 md:py-20 px-5 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="amplessoft text-4xl md:text-5xl font-bold text-[#0B0E14] mb-6">Term Loan Eligibility Criteria</h2>
        ...
        <div className="text-center mt-16">
          <button
            ...
            className="bg-[#0B0E14] text-[#E5E7EB] px-10 py-5 rounded-xl font-bold text-lg hover:shadow-xl transition-all"
          >
            Check My Term Loan Eligibility Now
          </button>
        </div>
      </div>
    </section>
...
function HowWeHelp() {
  ...
  return (
    <section id="how-to-apply" className="bg-[#E5E7EB] py-16 md:py-20 px-5 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="amplessoft text-4xl md:text-5xl font-bold text-[#0B0E14]">How to Apply for Term Loan</h2>
...
function DocumentsRequired() {
  ...
  return (
    <section className="bg-[#E5E7EB] py-16 md:py-20 px-5 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="amplessoft text-4xl md:text-5xl font-bold text-[#0B0E14]">Documents Required for Term Loan</h2>
...
function WhyChooseUs() {
  ...
  return (
    <section className="bg-[#E5E7EB] py-16 md:py-20 px-5 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="amplessoft text-4xl md:text-5xl font-bold text-[#0B0E14]">Why Choose Us for Term Loan?</h2>
        </div>
...
function FAQ() {
  ...
  const faqs = [
    ...
    {
      q: "Who can apply for Tata Capital Term Loan?",
