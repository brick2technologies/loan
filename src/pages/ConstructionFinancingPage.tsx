...
function HeroSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Construction Financing Form Data:", formData);
            ...
            <div className="relative z-10 max-w-xl lg:max-w-2xl mx-auto lg:mx-0 text-center lg:text-left">
              <h1 className="amplessoft text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight tracking-tight text-[#0B0E14]">
                ...
                <span className="text-[#1F2937] font-semibold">
                  — Build Your Vision • Flexible Funding
                </span>
              </h1>
              <p className="mt-6 text-base sm:text-lg md:text-xl text-[#374151] leading-relaxed max-w-prose mx-auto lg:mx-0">
                Finance your construction projects, new building development, infrastructure, or commercial renovations with long-term funding.  
                ₹1 Lakh – ₹90 Lakhs • Starting @12%* p.a. • Tenure up to 60 months • No collateral • Quick online process
              </p>
            </div>

            <div className="hidden lg:block relative">
              <img
                src="/images/construction-financing-hero.png"
                alt="Construction site with new building project financed through construction loan"
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
              ...
              >
                ...
                <option value="new-building">New Building / Construction</option>
            ...
            <label className="flex items-start gap-3 text-sm text-gray-600 cursor-pointer select-none">
              ...
              <span className="leading-relaxed">
                I authorize sharing my information for construction financing processing as per RBI guidelines & privacy policy.
              </span>
            </label>
          </form>
        </div>
    ...
    <section id="overview" className="py-16 px-6 bg-[#E5E7EB]">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="amplessoft text-4xl md:text-5xl font-bold text-gray-900 mb-5">What is Construction Financing?</h2>
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Construction financing provides long-term funding to support new building projects, infrastructure development, commercial real estate, or renovation/expansion of existing structures. It helps builders, developers, and businesses complete projects without upfront capital strain.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-8">
            <div>
              ...
              <ul className="space-y-3 text-gray-600">
                ...
                <li className="flex items-start"><span className="text-[#0B0E14] mr-3 text-xl">•</span>Quick approval & phased disbursal</li>
              </ul>
            </div>
            <div>
              <h3 className="amplessoft text-2xl font-semibold text-gray-800 mb-4">Most Common Uses</h3>
              <p className="text-gray-600">
                New residential/commercial building construction, infrastructure projects (roads, bridges), factory/warehouse construction, building renovation & expansion, or any large-scale construction activity.
              </p>
            </div>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {[
              { title: "New Building Construction", desc: "Residential / Commercial projects" },
              { title: "Infrastructure Development", desc: "Roads, bridges, public works" },
              { title: "Factory / Warehouse", desc: "Industrial building projects" },
              { title: "Renovation & Expansion", desc: "Upgrade existing structures" },
              { title: "Commercial Real Estate", desc: "Office spaces, retail buildings" },
              { title: "Specialized Construction", desc: "Hospitals, schools, hotels" },
            ].map((item) => (
              <div
                key={item.title}
...
// ────────────────────────────────────────────────────────────────────────────────
// TYPES OF CONSTRUCTION FINANCING (unchanged)
// ────────────────────────────────────────────────────────────────────────────────
function TypesOfConstructionFinancing() {
  const loanTypes = [
    {
      title: "New Building Construction Financing",
      description: "Fund complete construction of residential or commercial buildings from foundation to finish.",
      interest: "Starting 12%*",
      amount: "₹1 Lakh – ₹90 Lakhs",
      tenure: "12–60 months",
      bestFor: "Builders & developers",
      icon: "🏗️",
    },
    {
      title: "Infrastructure Project Financing",
      description: "Finance roads, bridges, public utilities, or large-scale infrastructure developments.",
      interest: "Starting 12%*",
      amount: "₹1 Lakh – ₹90 Lakhs",
      tenure: "12–60 months",
      bestFor: "Infrastructure companies",
      icon: "🛣️",
    },
    {
      title: "Factory / Industrial Construction Financing",
      description: "Fund new factory, warehouse, or industrial facility construction.",
      interest: "Starting 12%*",
      amount: "₹1 Lakh – ₹90 Lakhs",
      tenure: "12–60 months",
    ...
    {
      title: "Renovation & Expansion Financing",
      description: "Finance renovation, extension, or upgradation of existing buildings/structures.",
      interest: "Starting 12%*",
      amount: "₹1 Lakh – ₹90 Lakhs",
      tenure: "12–60 months",
      bestFor: "Existing property owners",
      icon: "🔧",
    },
  ];
    ...
    <section id="types" className="bg-[#E5E7EB] py-16 md:py-20 px-5 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="amplessoft text-3xl sm:text-4xl md:text-5xl font-bold text-[#0B0E14]">Types of Construction Financing</h2>
          <p className="mt-5 text-lg md:text-xl text-gray-700 max-w-3xl mx-auto">
            Tailored financing options for every construction project — big or small.
          </p>
        </div>
...
// FEATURES & BENEFITS
// ────────────────────────────────────────────────────────────────────────────────
function ConstructionFinancingFeatures() {
  const { openModal } = useLoanModal();
  ...
  const features = [
    {
      ...
      desc: "Funding from <strong>₹1 Lakh – ₹90 Lakhs</strong> based on project size",
      highlight: "₹1L – ₹90L",
    },
    {
      icon: "📅",
    ...
    },
    {
      ...
      desc: "Fixed or Structured EMI to match project cash flow",
    ...
    {
      icon: "⚡",
      title: "Quick Approval & Phased Disbursal",
      desc: "Fast sanction & funds released in phases as per construction progress",
      highlight: "Phased Funding",
    },
    {
      icon: "🛡️",
    ...
    <section id="features" className="bg-[#E5E7EB] py-16 md:py-20 px-5 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="amplessoft text-4xl md:text-5xl font-bold text-[#0B0E14]">Construction Financing Features & Benefits</h2>
          <p className="mt-6 text-xl text-gray-700 max-w-3xl mx-auto">
            Build your projects • Flexible repayment • Fast & easy • No collateral
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          ...
          >
            Apply for Construction Financing Now
          </button>
        </div>
      </div>
    </section>
...
function LoanDetails() {
  ...
  return (
    <section id="interest" className="bg-[#E5E7EB] py-16 md:py-20 px-5 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="amplessoft text-4xl md:text-5xl font-bold text-[#0B0E14]">Construction Financing at a Glance</h2>
          <p className="mt-5 text-xl text-gray-700">Affordable • Transparent • Project-friendly</p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            { title: "Loan Amount", value: "₹1 Lakh – ₹90 Lakhs", highlight: "As per project" },
        ...
        <div className="text-center mt-16">
          ...
          >
            Get Your Construction Financing Offer Now
          </button>
        </div>
      </div>
    </section>
  ...
  return (
    <section id="eligibility" className="bg-[#E5E7EB] py-16 md:py-20 px-5 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="amplessoft text-4xl md:text-5xl font-bold text-[#0B0E14] mb-6">Construction Financing Eligibility</h2>
        <p className="text-xl text-gray-700 mb-12">Simple criteria for builders, developers & businesses</p>
        ...
        <div className="text-center mt-16">
          <button
            ...
            className="bg-[#0B0E14] text-[#E5E7EB] px-10 py-5 rounded-xl font-bold text-lg hover:shadow-xl transition-all"
          >
            Check My Construction Financing Eligibility Now
          </button>
        </div>
      </div>
    </section>
...
function HowWeHelp() {
  ...
  const steps = [
    { number: 1, title: "Apply Online", desc: "Fill basic project details" },
    { number: 2, title: "Upload Documents", desc: "KYC & project details digitally" },
    ...
    { number: 5, title: "Disbursal", desc: "Phased funds as per project progress" },
  ];
  ...
  return (
    <section id="how-to-apply" className="bg-[#E5E7EB] py-16 md:py-20 px-5 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="amplessoft text-4xl md:text-5xl font-bold text-[#0B0E14]">How to Apply for Construction Financing</h2>
        ...
        <div className="text-center mt-16">
          <button
            ...
            className="bg-[#0B0E14] text-[#E5E7EB] px-10 py-5 rounded-xl font-bold text-lg hover:shadow-xl transition-all"
          >
            Start Your Construction Financing Application
          </button>
        </div>
      </div>
    </section>
...
function DocumentsRequired() {
  ...
  const docs = [
    ...
    },
    {
      ...
      items: ["Project plan / estimate", "Approvals & permissions", "Quotation / drawings"],
      icon: "🏗️",
    },
  ];
  ...
  return (
    <section className="bg-[#E5E7EB] py-16 md:py-20 px-5 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="amplessoft text-4xl md:text-5xl font-bold text-[#0B0E14]">Documents Required for Construction Financing</h2>
...
function WhyChooseUs() {
  ...
  return (
    <section className="bg-[#E5E7EB] py-16 md:py-20 px-5 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="amplessoft text-4xl md:text-5xl font-bold text-[#0B0E14]">Why Choose Us for Construction Financing?</h2>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-[#0B0E14] text-white rounded-2xl p-8 shadow-2xl">
            ...
            <ul className="space-y-4">
              ...
              <li><span className="text-green-400">✓</span> Quick online approval & phased disbursal</li>
        ...
        <div className="text-center mt-12">
          <button
            ...
            className="bg-[#0B0E14] text-[#E5E7EB] px-10 py-5 rounded-xl font-bold text-lg hover:shadow-xl transition-all"
          >
            Get Your Best Construction Financing Offer
          </button>
        </div>
      </div>
    </section>
...
function FAQ() {
  ...
  const faqs = [
    {
      q: "What is the interest rate for Construction Financing?",
      a: "Interest rate starts from **12%** per annum (as of January 2026), depending on your project profile, CIBIL score & loan amount.",
    },
    {
      q: "What is the maximum construction financing amount?",
      a: "Up to **₹90 Lakhs** — based on project cost, business turnover, financials, and repayment capacity.",
    },
    {
      q: "What is the tenure for construction financing?",
      a: "Flexible tenure from **12 to 60 months** — choose what suits your project cash flow.",
    },
    {
      q: "Is collateral required for construction financing?",
      a: "No — Tata Capital offers **unsecured** construction financing with no collateral.",
    },
    {
      q: "What documents are required?",
      a: "KYC (PAN/Aadhaar), business proof (GST/Trade License), last 2 years ITR, audited financials, 6 months bank statements & project estimates/plans.",
    },
    {
      q: "Who can apply for Construction Financing?",
      a: "Builders, developers, contractors, infrastructure companies, and businesses with good credit score (675+ preferred).",
    },
  ];
...
export default function ConstructionFinancingPage() {
  return (
    <main className="bg-[#E5E7EB]">
      ...
      <LoanOverview />
      <LoanTabs />
      <TypesOfConstructionFinancing />
      <ConstructionFinancingFeatures />
      <LoanDetails />
      <Eligibility />
      <HowWeHelp />
      <DocumentsRequired />
